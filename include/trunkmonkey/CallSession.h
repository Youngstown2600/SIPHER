...
public:
    ...
    void setQueueAudioFile(std::string path);
    void attachAudio();
    void detachAudio();
...
private:
    ...
    void attachQueueAudio();
    void detachQueueAudio();
    Logger& logger_;
    ...
    std::string queueAudioPath_;
    std::unique_ptr<pj::AudioMediaPlayer> queueAudioPlayer_;
    bool queueAudioAttached_{false};
};
}
